...
author: "Sky Suh"
thanks: "Codes and datas for this analysis paper are available at: https://github.com/sjp2023/Deaths_of_People_Experiencing_Homelessness"
date: Jan 20, 2024
...
#| message: false
#| echo: false
#| label: fig-correlation-of-month
#| fig-cap: Correlation between month and death roll count before/after COVID-19
...
cleaned_month_data |>
  ggplot(data, mapping = aes(x = month_of_death, y = count)) +
  geom_point() +
  labs(
    title = "Month of Death vs Count for death toll of homeless before/after COVID-19",
    x = "Month from before to after COVID-19",
...
cleaned_cause_data3 |>
  ggplot(data, mapping = aes(x = year_of_death, y = count)) +
  geom_point() +
  labs(
